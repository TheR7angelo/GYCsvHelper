...
namespace LibsExportGlobal.ExportGlobal.SStruc.ExportGlobal;
...
public class ExportGlobalConvert : INotifyPropertyChanged, IConvert
{
    ...
    private string _tmpxx1Xx = string.Empty;

    [Name("tmpxx1xx"), Default("")]
    public string Tmpxx1Xx
    {
        get => _tmpxx1Xx;
        set
        {
    ...
    private string _tmpxx2Xx = string.Empty;

    [Name("tmpxx2xx"), Default("")]
    public string Tmpxx2Xx
    {
        get => _tmpxx2Xx;
        set
        {
    ...
    private string _tmpxx3Xx = string.Empty;

    [Name("tmpxx3xx"), Default("")]
    public string Tmpxx3Xx
    {
        get => _tmpxx3Xx;
        set
        {
    ...
    private string _tmpxx4Xx = string.Empty;

    [Name("tmpxx4xx"), Default("")]
    public string Tmpxx4Xx
    {
        get => _tmpxx4Xx;
        set
        {
    ...
    private string _tmpxx5Xx = string.Empty;

    [Name("tmpxx5xx"), Default("")]
    public string Tmpxx5Xx
    {
        get => _tmpxx5Xx;
        set
        {
    ...
    private string _tmpxx6Xx = string.Empty;

    [Name("tmpxx6xx"), Default("")]
    public string Tmpxx6Xx
    {
        get => _tmpxx6Xx;
        set
        {
    ...
    private string _tmpxx7Xx = string.Empty;

    [Name("tmpxx7xx"), Default("")]
    public string Tmpxx7Xx
    {
        get => _tmpxx7Xx;
        set
        {
    ...
    private string _tmpxx8Xx = string.Empty;

    [Name("tmpxx8xx"), Default("")]
    public string Tmpxx8Xx
    {
        get => _tmpxx8Xx;
        set
        {
    ...
    private string _tmpxx9Xx = string.Empty;

    [Name("tmpxx9xx"), Default("")]
    public string Tmpxx9Xx
    {
        get => _tmpxx9Xx;
        set
        {
    ...
    private string _tmpxx10Xx = string.Empty;

    [Name("tmpxx10xx"), Default("")]
    public string Tmpxx10Xx
    {
        get => _tmpxx10Xx;
        set
        {
    ...
    private string _tmpxx11Xx = string.Empty;

    [Name("tmpxx11xx"), Default("")]
    public string Tmpxx11Xx
    {
        get => _tmpxx11Xx;
        set
        {
    ...
    private string _tmpxx12Xx = string.Empty;

    [Name("tmpxx12xx"), Default("")]
    public string Tmpxx12Xx
    {
        get => _tmpxx12Xx;
        set
        {
    ...
    public ExportGlobalConvert()
    {
        _propsMain = GetType().GetProperties();
    }
    
    public void ConvertInit(object record, IConvert instance) => SetValue((ExportGlobal)record);
    
    private void SetValue(ExportGlobal restitCheckControl)
    {
        foreach (var prop in _propsMain)
        {
            if (!_propsMain.Contains(prop)) continue;
    
            var value = (string?) restitCheckControl.GetType().GetProperty(prop.Name)?.GetValue(restitCheckControl, null) ?? string.Empty;

            try
            {
                if (!value.Equals(string.Empty))
                {
                    if (value[0].Equals('\'')) value = value.Remove(0, 1);
                    if (value[^1].Equals('\'')) value = value.Remove(value.Length-1, 1);
                }
            }
            catch (Exception e)
            {
